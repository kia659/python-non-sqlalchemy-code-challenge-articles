...
class Author:
    ...
    def name(self, name):
        if not isinstance(name, str):
            raise TypeError("name should be strings")
        elif len(name) == 0:
            raise ValueError("name should be longer than 0 chars")
...
class Magazine:
    ...
    def articles(self):
        return [articles for articles in Article.all if articles.magazine is self]
